...
#if defined(NDEBUG)
# error "HYDRAX cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "HYDRAX Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // HYDRAX also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // HYDRAX also requires low S in sigs
