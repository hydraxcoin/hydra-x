...
const QString BITCOIN_IPC_PREFIX("hydrax:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/hydrax-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/hydrax-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/hydrax-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click hydrax: links
...
//
// OSX-specific way of handling hydrax: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in hydrax: URIs
