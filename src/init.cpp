...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hydraxcoin/hydra-x>";
    const std::string URL_WEBSITE = "<https://hydra-x.org/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The HYDRA-X Developers", 2021)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find HYDRAX useful. "
